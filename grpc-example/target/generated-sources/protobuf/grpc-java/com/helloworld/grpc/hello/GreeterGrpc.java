package com.helloworld.grpc.hello;
...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.helloworld.grpc.hello.HelloRequest,
      com.helloworld.grpc.hello.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.helloworld.grpc.hello.HelloRequest.class,
      responseType = com.helloworld.grpc.hello.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.helloworld.grpc.hello.HelloRequest,
      com.helloworld.grpc.hello.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.helloworld.grpc.hello.HelloRequest, com.helloworld.grpc.hello.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.helloworld.grpc.hello.HelloRequest, com.helloworld.grpc.hello.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.helloworld.grpc.hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.helloworld.grpc.hello.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.helloworld.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.helloworld.grpc.hello.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(com.helloworld.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.helloworld.grpc.hello.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public com.helloworld.grpc.hello.HelloReply sayHello(com.helloworld.grpc.hello.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.helloworld.grpc.hello.HelloReply> sayHello(
        com.helloworld.grpc.hello.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.helloworld.grpc.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.helloworld.grpc.hello.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.helloworld.grpc.hello.HelloRequest,
              com.helloworld.grpc.hello.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.helloworld.grpc.hello.HelloProto.getDescriptor();
    }
